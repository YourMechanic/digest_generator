...
Gem::Specification.new do |spec|
  ...
  spec.description   = "Generates Hash 64 and mask bit 63 (0-63) to remove signedness to be compatible with postgres bigints"
  ...
  spec.add_development_dependency 'xxhash', '~> 0.4.0'
